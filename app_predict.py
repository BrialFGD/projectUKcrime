...
def app():
    ...
    st.markdown(f'**Here is a PREDICTION of possible outcomes probabilities of a {st.session_state.crime_type[0]} crime recorded in {st.session_state.city} a year after.**')
